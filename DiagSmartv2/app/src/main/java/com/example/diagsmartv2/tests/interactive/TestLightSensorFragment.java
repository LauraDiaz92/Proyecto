...
public class TestLightSensorFragment extends Fragment implements SensorEventListener {
    ...
    /**
     * Binds lux display TextView, Yes/No buttons and light sensor ImageView from the layout.
     *
    ...
    /**
     * Initializes SensorManager and light sensor. Shows error message if
    ...
    /**
     * Registers the light sensor listener with normal sampling rate when the fragment becomes visible.
     */
    @Override
    ...
    /**
     * Unregisters the light sensor listener to save battery when the fragment is paused.
     */
    @Override
    public void onPause() {
        super.onPause();
    ...
    /**
     * Updates the lux display TextView with the current light level reading.
     *
     * @param event SensorEvent containing light sensor lux value.
     */
    @Override
